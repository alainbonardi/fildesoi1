...
class mydsp : public dsp {
  ...
  public:
	...
	virtual void buildUserInterface(UI* interface) {
		...
		interface->addHorizontalSlider("freq0", &fslider0, 1.0, -1e+01, 1e+01, 0.01);
		interface->addHorizontalSlider("freq1", &fslider2, 1.0, -1e+01, 1e+01, 0.01);
		interface->addHorizontalSlider("freq2", &fslider4, 1.0, -1e+01, 1e+01, 0.01);
		interface->addHorizontalSlider("freq3", &fslider6, 1.0, -1e+01, 1e+01, 0.01);
		interface->addHorizontalSlider("phase0", &fslider1, 0.0, 0.0, 1.0, 0.01);
		interface->addHorizontalSlider("phase1", &fslider3, 0.0, 0.0, 1.0, 0.01);
		interface->addHorizontalSlider("phase2", &fslider5, 0.0, 0.0, 1.0, 0.01);
		interface->addHorizontalSlider("phase3", &fslider7, 0.0, 0.0, 1.0, 0.01);
		interface->closeBox();
	}
	virtual void compute (int count, FAUSTFLOAT** input, FAUSTFLOAT** output) {
		...
		double 	fSlow3 = (fSlow2 * iSlow1);
		double 	fSlow4 = (fSlow2 + (fSlow0 < 0));
		double 	fSlow5 = (fConst0 * double(fSlow0));
		int 	iSlow6 = (1 - iSlow1);
		double 	fSlow7 = double(fslider2);
		int 	iSlow8 = (fSlow7 == 0);
		double 	fSlow9 = double(fslider3);
		double 	fSlow10 = (fSlow9 * iSlow8);
		double 	fSlow11 = (fSlow9 + (fSlow7 < 0));
		double 	fSlow12 = (fConst0 * double(fSlow7));
		int 	iSlow13 = (1 - iSlow8);
		double 	fSlow14 = double(fslider4);
		int 	iSlow15 = (fSlow14 == 0);
		double 	fSlow16 = double(fslider5);
		double 	fSlow17 = (fSlow16 * iSlow15);
		double 	fSlow18 = (fSlow16 + (fSlow14 < 0));
		double 	fSlow19 = (fConst0 * double(fSlow14));
		int 	iSlow20 = (1 - iSlow15);
		double 	fSlow21 = double(fslider6);
		int 	iSlow22 = (fSlow21 == 0);
		double 	fSlow23 = double(fslider7);
		double 	fSlow24 = (fSlow23 * iSlow22);
		double 	fSlow25 = (fSlow23 + (fSlow21 < 0));
		double 	fSlow26 = (fConst0 * double(fSlow21));
		int 	iSlow27 = (1 - iSlow22);
		...
		for (int i=0; i<count; i++) {
			double fTemp0 = (double)input7[i];
			double fTemp1 = (double)input8[i];
			double fTemp2 = (double)input9[i];
			double fTemp3 = (double)input10[i];
			output0[i] = (FAUSTFLOAT)(fTemp3 + (fTemp2 + (fTemp1 + ((double)input0[i] + fTemp0))));
			fRec0[0] = fmod((fRec0[1] + fSlow5),1.0);
			double fTemp4 = ((iSlow6 * fmod((fRec0[0] + fSlow4),1)) + fSlow3);
			double fTemp5 = (6.283185307179586 * fTemp4);
			fRec1[0] = fmod((fRec1[1] + fSlow12),1.0);
			double fTemp6 = ((iSlow13 * fmod((fRec1[0] + fSlow11),1)) + fSlow10);
			double fTemp7 = (6.283185307179586 * fTemp6);
			fRec2[0] = fmod((fRec2[1] + fSlow19),1.0);
			double fTemp8 = ((iSlow20 * fmod((fRec2[0] + fSlow18),1)) + fSlow17);
			double fTemp9 = (6.283185307179586 * fTemp8);
			fRec3[0] = fmod((fRec3[1] + fSlow26),1.0);
			double fTemp10 = ((iSlow27 * fmod((fRec3[0] + fSlow25),1)) + fSlow24);
			double fTemp11 = (6.283185307179586 * fTemp10);
			output1[i] = (FAUSTFLOAT)((fTemp3 * sin(fTemp11)) + ((fTemp2 * sin(fTemp9)) + ((fTemp1 * sin(fTemp7)) + ((double)input1[i] + (fTemp0 * sin(fTemp5))))));
			output2[i] = (FAUSTFLOAT)((fTemp3 * cos(fTemp11)) + ((fTemp2 * cos(fTemp9)) + ((fTemp1 * cos(fTemp7)) + ((double)input2[i] + (fTemp0 * cos(fTemp5))))));
			double fTemp12 = (12.566370614359172 * fTemp4);
			double fTemp13 = (12.566370614359172 * fTemp6);
			double fTemp14 = (12.566370614359172 * fTemp8);
			double fTemp15 = (12.566370614359172 * fTemp10);
			output3[i] = (FAUSTFLOAT)((fTemp3 * sin(fTemp15)) + ((fTemp2 * sin(fTemp14)) + ((fTemp1 * sin(fTemp13)) + ((double)input3[i] + (fTemp0 * sin(fTemp12))))));
			output4[i] = (FAUSTFLOAT)((fTemp3 * cos(fTemp15)) + ((fTemp2 * cos(fTemp14)) + ((fTemp1 * cos(fTemp13)) + ((double)input4[i] + (fTemp0 * cos(fTemp12))))));
			double fTemp16 = (18.84955592153876 * fTemp4);
			double fTemp17 = (18.84955592153876 * fTemp6);
			double fTemp18 = (18.84955592153876 * fTemp8);
			double fTemp19 = (18.84955592153876 * fTemp10);
			output5[i] = (FAUSTFLOAT)((fTemp3 * sin(fTemp19)) + ((fTemp2 * sin(fTemp18)) + ((fTemp1 * sin(fTemp17)) + ((double)input5[i] + (fTemp0 * sin(fTemp16))))));
			output6[i] = (FAUSTFLOAT)((fTemp3 * cos(fTemp19)) + ((fTemp2 * cos(fTemp18)) + ((fTemp1 * cos(fTemp17)) + ((double)input6[i] + (fTemp0 * cos(fTemp16))))));
			// post processing
			fRec3[1] = fRec3[0];
			fRec2[1] = fRec2[0];
			fRec1[1] = fRec1[0];
